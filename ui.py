...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.centralwidget.setStyleSheet("background-color: #dade0d;")
...
"}")
        ...
        self.frame.setStyleSheet("background-color: #0d30de")
...
"")
        ...
        self.input_currency.setStyleSheet("background-color: #0d30de;\n"
"border: 2px solid #0d30de;\n"
"border-radius: 30;\n"
"color: white;")
        ...
        self.output_currency.setStyleSheet("background-color: #0d30de;\n"
"border: 2px solid #0d30de;\n"
"border-radius: 30;\n"
"color: white;")
